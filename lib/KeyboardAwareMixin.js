...
const KeyboardAwareMixin = {
  ...
  updateKeyboardSpace: function (frames: Object) {
    let keyboardSpace: number = frames.end.height + this.props.extraScrollHeight
        ...
        (isAncestor) => {
          if (isAncestor) {
            ...
            UIManager.measureInWindow(currentlyFocusedField, (x, y, width, height) => {
              if (y + height > frames.end.screenY - this.props.extraScrollHeight - this.props.extraHeight) {
